...
\item README and setup is in \href{https://github.com/schoeberl/agile-hw/tree/main/lab3}{lab3}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Agile development is about change -- it shall be fun
\item We use Scala to write hardware generators
\item Next week: continue with generators
\item Next week: you shall have an initial idea of a project (present one slide)
\end{itemize}
\end{frame}
\end{document}
