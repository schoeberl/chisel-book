...
\begin{itemize}
\item This is a (relatively) new course
\begin{itemize}
...
\begin{itemize}
    ...
    \item Slow requirements or design can be the bottleneck
        \item I worked (a long time ago) in such a team

    \begin{itemize}
    \item At Compaq for a banking SW
    \item It was very boring
    \item Read a lot of newspapers
\end{itemize}
...
\begin{itemize}
    ...
    \item Shorter iteration cycles with AI
\end{itemize}
\end{frame}
...
\textbf{Review / Demo}
\begin{itemize}
    \item Present completed work to the team or stakeholders (me)
...
\end{itemize}
    \item Frequent review and refactoring
    \begin{itemize}
...
\begin{frame}[fragile]{Prerequisits}
\begin{itemize}
\item This is an advanced hardware course
\item You should know basic digital design 
\item DTU: DE1 and DE2, or computer systems
\item You should know an OO language (e.g., Java)
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Test Yourself: Combinational versus Sequential}
\begin{itemize}
\item Can you draw an AND gate?
\item What is a register (FF)?
\item What is the difference?
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Test Yourself: Counter}
\begin{itemize}
\item Design a counter
\item Using a register, adder, multiplexer, and comparator
\item a 4-bit counter that counts 0,1,...,9,0,1,...
\item Draw the schematics
\item How far can one count with 5 bits?
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Test Yourself: HDL}
\begin{itemize}
\item What does this pseudo code describe?
...
\begin{frame}[fragile]{Test Yourself: Combinational Hardware from Code}
\begin{itemize}
\item What does the following code describe?
\begin{verbatim}
if sel:
    y = a
else:
...
\begin{frame}[fragile]{Test Yourself}
\begin{verbatim}
        +-----+
   +--->| + 1 |---+
   |    +-----+   |
   ...
   +----------|  Reg  |
              +---+---+
                  ...
                  q\end{verbatim}
\begin{itemize}
\item What does this circuit do?
\item What determines how quickly \code{q} changes?
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Usage of AI}
\begin{itemize}
\item AI (LLM) is an engineering tool
\item You need to know how to specify a task
\item You need to be able to assess the result
\item Generation is cheap
\item Confidence is expensive
\item LLMs can generate Chisel
\item You are responsible for:
\begin{itemize}
\item understanding the generated hardware
\item correctness
\item verification
\item design decisions
\end{itemize}
\item You shall write some code without using LLMs
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Let us Explore AI now}
\begin{itemize}
\item Pick your favorite AI
\item Ask an AI to generate a Chisel modulo-10 counter
\item With an enable input and synchronous clear
\item What hardware will be generated?
\item How would you test it?
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Which Solution is Good/Bad?}
\begin{verbatim}
// A
when (cnt === 9.U) {
  cnt := 0.U
...
\begin{itemize}
\item Was there something missing?
\end{itemize}
\end{frame}
