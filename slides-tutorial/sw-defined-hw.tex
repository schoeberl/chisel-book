...
\begin{itemize}
\item Conditional update, but no latches, Chisel checks
\item offer additional lectures and labs if there is interest
\item Update BCD code for the simpler one
\end{itemize}
\end{frame}
