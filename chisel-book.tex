...
counter that can generate a single-cycle \emph{tick} signal every millisecond.
Use the signal as enable signal for the 4-bit counter.
...
of data and handshaking for flow-control.
...
Figure~\ref{fig:readyvalid}). The sender asserts \code{valid} when data is available
