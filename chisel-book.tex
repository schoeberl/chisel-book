...
\noindent A minimal test (a testing hello world) to just test the Scala Integer
addition:

\input{code/scalatest_hello_world.txt}

\noindent Although Chisel testing is more heavyweight than Scala unit testing,
