...
\noindent If we are in the mood of counting down, we start by reseting the counter register
...
counting by selecting input line of the multiplexer that provides \code{0}.
