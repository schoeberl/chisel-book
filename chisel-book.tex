...
started to collect small Chisel components, including the presented FIFO buffers and the serial
port.

\item[\myref{https://github.com/ucb-bar/constellation}{Constellation}] is a NoC generator~\cite{Constellation:2022}
for irregular NoC structures that supports wormhole routing, virtual channels, and credit-based flow control.
It uses AXI-4 or TileLink as the interface and translates a master/slave bus protocol into NoC messages.
