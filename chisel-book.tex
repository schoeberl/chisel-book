...
We have changed the testing description to the new ChiselTest framework.
...
A description how to use the \codefoot{PeekPokeTester} can be found in the 2nd edition
of the Chisel Book.}
