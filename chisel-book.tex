...
value and it is added to the PC. For the \code{jal} instruction the PC can also be loaded from \code{A}.
...
It also includes the generation of an operand for instructions with an immediate operand
