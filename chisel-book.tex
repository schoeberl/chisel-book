...
The description of the instructions fits on one page:
...
\todo{Make this a nice table, explaining the instructions}
...
selected some corner cases as input values. Beside testing agains corner cases it is also useful
...
\begin{verbatim}
$ leros martin$ sbt "test:runMain leros.AluTester"
\end{verbatim}
