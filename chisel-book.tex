...
a cool hardware construction language, which is so joyful to use and
...
learning and using a bleeding edge hardware language. I know, some of
...
\noindent As we are in the mood of writing and using more counters, we can
...
In an FPGA where logic is built out of lookup tables, the resource consumption
is the same for the up and down counter.

We want to generate a tick every N clock cycles.
