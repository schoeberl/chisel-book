...
in real hardware in an FPGA. As a next step we will take a first look on how the build
...
can be selected.
You can also directly provide the object that shall be executed as parameter to \code{sbt}:

\begin{verbatim}
$ sbt run mypacket.MyObject
\end{verbatim}
...
We will show this possibilities later.
