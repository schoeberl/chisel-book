...
\section{A Classic Micorprocessor Bus}
...
Modern computers have different busses for different peripheral devicrs, e.g., a dedicated memory
...
connection. Masters and peripheral devices are connected with such a point-to-point
interface to a switching fabric.

\todo{Multiple masters need an arbiter.}
