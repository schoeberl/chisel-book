...
Synchronous memories have registers on their inputs (address, write data,
...
An interesting question is which data value is returned when in the same clock
...
(which might be a mix some bits of the old and some of the newly written data).
