...
We run the ticker tests only with:
\begin{chisel}
...
in the same code base, maybe executed during hardware generation.

A classic example I have used in teaching is the conversion of a binary number
into binary...
