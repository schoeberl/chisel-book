...
at the Technical University of Denmark contains the slides for a 13 weeks course, based in Chisel.
...
contains Chisel exercises for the course ``Digital Electronics 2'' .
...
\todo{talk on arbitration...}
Following code shows an arbiter for 3 clients.

\shortlist{code/arbiter3.txt}

\todo{Small arbiters an also be directly implemented}

\todo{The loop version}
