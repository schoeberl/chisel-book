...
in the above example, the type of the variables is \emph{inferred}. It is a Scala \code{Int} type.
The Scala compiler in most cases is ale to infer the type. However, if we are in the mood if
