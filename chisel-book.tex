...
Hardware designers, with a knowledge in Verilog or VHDL, can upgrade
their productivity with a modern language for their next ASIC design.
Software engineers, with knowledge of object oriented and functional
programming, can use their knowledge to program hardware, for example
FPGA accelerators executing in the cloud.
...
An FSM consists of three parts: (1) a register that holds the current state,
