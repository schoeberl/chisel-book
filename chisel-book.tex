...
components, such an adder, and huge components.

Beginners in hardware design often start with tiny components.
The problem is that design books use tiny components to show the principles.
...
However, there is some boilerplate when declaring a module and when instantiating and
connecting it.
...
Table~\ref{tab:encoder} shows the truth table of the encode function. However, an encoder will
...
The fundamental elements to build sequential circuits are registers. A register is a collection
