...
Maybe then compare. This needs some better writing, also put it into the soc-comm README.}
 ...
 A read or write command are signaled by an asserted \code{rd} or \code{wr}.
...
till the acknowledgment. Compared to the former protocol, the \code{ack} signal comes
...
It has the same latency as the former example.
