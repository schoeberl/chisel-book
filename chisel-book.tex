...
that single cycle \code{risingEdge} signal to increment a counter.
...
Here we define a simple pipelined handshake bus protocol that avoids the single-cycle combinational loop and fits better for modern SoC designs.
