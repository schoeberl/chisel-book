...
Listing~\ref{lst:ch:use} shows how to create a component in Chisel and connect to the input
and output ports.

Listing~\ref{lst:vhdl:use} shows how to declare and use the \code{adder} in VHDL.
As VHDL is strongly typed, a component needs to be declared before used.
...
Listing~\ref{lst:sv:ch:register} shows a register with reset and enable in Chisel, using
