...
features that we cover in this edition. These are peeking a Scala integer directly without a conversion, or putting the class
\code{ChiselEnum} into the main package.
