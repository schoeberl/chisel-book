...
\todo{The above code is Chisel 3 in Chisel 2 compatibility mode. Switch to the real Chisel 3 code.}
...
Each chapter ends with a few hands-on exercises. For the introduction exercise we will use and
FPGA board to get one LED blinking LED.
...
Voila, you managed to get your first design in Chisel running in an FPGA!
