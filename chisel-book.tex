...
Therefore, you can also contribute to the project. Here describe how to
...
Fork the repository, which you like to contribute, into your local GitHub account.
...
Compile your Chisel test application and watch if it picks up the local published
version of the Chisel library.
