...
Install the Java OpenJDK 8 as from \myref{https://adoptopenjdk.net/}{AdoptOpenJDK}.
...
Install the Java OpenJDK as mentioned above from \myref{https://adoptopenjdk.net/}{AdoptOpenJDK}.
...
clock cycles (\code{nrCycles}), and a Chisel wire (\code{din}) that gives the threshold for the
