...
\item Get pupils excited about this study line
\item Thursday 5 March starting at 12:00 ending at 19:00
\item You get some pay, drinks, and food
\item Please contact \href{https://orbit.dtu.dk/en/persons/emad-jacob-maroun/}{Emad Jacob Maroun}
\end{itemize}
\end{frame}
...
\item Show the CLI commands (local)
\end{itemize}
\end{frame}
...
\begin{itemize}
\item 420 million repositories and 150 million developers
\end{itemize}
...
\end{itemize}
\item Show usage with two users
\end{itemize}
\end{frame}
...
\item We added a new exercise, please update your copy of the lab
\end{itemize}
\end{frame}
