...
\begin{frame}[fragile]{External Lecturer in Week 5}
\begin{itemize}
\item Next week (5/3)
\item Kasper will lecture on timing
\item Slides will be in DTU Learn
\item Paper and pencil exercises in the lab (from Dally)
\item Please bring your Dally book
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Let's Talk about Clocks}
\end{frame}

\begin{frame}[fragile]{Clocks}
\begin{itemize}
\item 95\% of designs are single clock
\item Multiple clocks need clock domain crossing
\begin{itemize}
\item Not in DE2, but in Design of Digital Systems
\end{itemize}
\item No clock division, no chains of FFs
\item No AND gate for clock gating
\begin{itemize}
\item Not in DE2, but in Design of Digital Systems
\item Use a register with enable, tools can figure it out
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Note the date: Tu 14 April afternoon
...
\item Several chip companies will present and participate
\item Opportunity to network for: theses with companies, internships, student jobs
\end{itemize}
\end{frame}
