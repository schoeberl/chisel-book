...
\item Hardware described in Chisel/Scala
...
\end{itemize}
\item All in a single programming language and a single program!
...
\item Make sure to checkout the chisel2 branch
\end{itemize}
\end{itemize}
\end{frame}
