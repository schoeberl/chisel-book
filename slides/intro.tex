...
\begin{itemize}
\item E.g., used to read in ROM content for a processor
\end{itemize}
\item Generate a truth table algorithmically
\begin{itemize}
\item E.g., could generate binary to BCD translation
\end{itemize}
\end{itemize}
\begin{chisel}
...
\begin{frame}[fragile]{Additional Files in the Hello World}
\begin{itemize}
