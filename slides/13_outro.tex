...
\item Report hand-in at DTU Learn (21 May)
...
\item See \href{https://www.compute.dtu.dk/english/news/nyhed?id=3a19bb25-a375-4537-9ac2-0311ede54ca9}{DTU Chip Day}
...
\begin{itemize}
\item We start with the Computer Engineering BSc in fall 2023
\end{itemize}
...
\begin{itemize}
\item 02155: Computer Architecture and Engineering
\item 02114: Design of a RISC-V Microprocessor (new, 3 weeks)
...
\begin{frame}[fragile]{Reading Recommondation}
\begin{itemize}
