...
\item Only four groups are missing: show it today to a TA
\end{itemize}
\end{frame}
...
\item I can pay for a few projects
\item \href{https://tinytapeout.com/}{Tiny Tapeout}
\item \href{https://github.com/TinyTapeout/ttihp-chisel-template}{Chisel template}
\end{itemize}
\end{frame}
...
\item Selecting an element for reading is a multiplexer
...
\begin{itemize}
\item It depends ;-)
\item Moore is on the safe side
\item Moore is composable
\item Mealy has \emph{faster} reaction
\item Both are tools in your toolbox
...
\begin{itemize}
\item 15' break
\item We are halfway through the course
\item Therefore, a midterm \href{https://docs.google.com/forms/d/e/1FAIpQLSfTjXyhZ9SSa_npWwr2t6msrPWVJUkC0QuoQQcXhBi_ElWqSQ/viewform?usp=header}{evaluation}
...
\item May violate the setup and hold time of a flip-flop
...
\begin{frame}[fragile]{Input Processing Cont.}
\begin{itemize}
\item Input can arrive at different clock cycles at different places
\item Also, reset needs to be synchronous
\begin{itemize}
\item Subsystems could reset one clock cycle apart
\item I call this my EUR 4000 issue
\end{itemize}
\end{itemize}
\end{frame}
...
\item We have a similar \href{https://kurser.dtu.dk/course/02201}{course} for the new CE Bachelor this fall
\end{itemize}
\end{frame}
...
\item Also finish your lab from last week and get the tick
\end{itemize}
\end{frame}
