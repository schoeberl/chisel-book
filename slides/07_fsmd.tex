...
\begin{itemize}
\item Talk on remote learning
\item Read the message and repeat the content
\item Explain the lab (at the end)
\item Repeat the testing including showing it on the screen
\item Try it out with some
\item Have the question on how to proceed with the lab
...
\end{itemize}
\item We will use Slack for quicker communication
...
\item Everyone can share the the scree or an individual window
\end{itemize}
...
\begin{itemize}
\item Everyone at DTU has access to the professional version
