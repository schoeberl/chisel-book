...
\end{itemize}
\item Register at \href{https://docs.google.com/spreadsheets/d/1aQs_VnPw3uiJxUz9WuzPcM1R6VkDXqPtri7a3pWoTvs/edit?usp=sharing}{Google spreadsheet}
\end{itemize}
\end{frame}
...
\item Specification document is in DTU Learn (show it)
\begin{itemize}
\item \href{https://learn.inside.dtu.dk/d2l/common/viewFile.d2lfile/Content/L2NvbnRlbnQvZW5mb3JjZWQvNjAyMzgtT0ZGRVJJTkctNjMzODE1L1ZlbmRpbmdNYWNoaW5lLnBkZg/VendingMachine.pdf?ou=60238}{VendingMachine.pdf}
\item Please test if you can download it
\end{itemize}
...
\begin{itemize}
\item Components and modules are two names for the same thing
\end{itemize}
...
\end{itemize}
When all tests succeed your are done ;-)
