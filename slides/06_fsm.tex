...
\begin{itemize}
\item Look into files at DTU Learn
\item Looks like it the 7-segment decoder was fine last week
\item This week it will be counters to test the 7-segment display
\item I am aware of that not everyone has an FPGA board
\item A lot can be done with simulation and testing
\item I do provide some FPGA board simulation
...
\begin{itemize}
\item Please register your group UPDATE! \href{https://docs.google.com/spreadsheets/d/1aQs_VnPw3uiJxUz9WuzPcM1R6VkDXqPtri7a3pWoTvs/edit?usp=sharing}{here}
\end{itemize}
...
\begin{frame}[fragile]{Today's Lab - Move to next week}
\begin{itemize}
