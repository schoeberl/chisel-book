...
\item Emil Arnika Skydsgaard
\item Tjark Petersen
\item Pleas say hello
\end{itemize}
\end{frame}

\begin{frame}[fragile]{Remote Learning}
\begin{itemize}
\item First 4 weeks online, then probably physical at DTU
\item First: this is all new for the most of you
\begin{itemize}
\item We need to be patient with each other
\end{itemize}
\item We should use Slack for quicker communication
\begin{itemize}
\item Please join all channels
\end{itemize}
...
\item Schedule a TA for help with Slack (channel \#help-queue)
...
\begin{itemize}
\item You are allowed and should meet physically as a group
...
\begin{itemize}
\item \href{https://adoptopenjdk.net/}{Java OpenJDK 8} (or 11) already installed for Java course
