...
\end{itemize}
\item This will not be an easy course
\begin{itemize}
\item But you will learn a lot, and it will make you a better
\begin{itemize}
\item engineer
...
\end{itemize}
\end{itemize}
\item Try to have fun on building stuff!
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Why Chisel?}
\begin{itemize}
...
\item {\bf You have your first Chisel design running!}
\end{itemize}
\end{frame}
