...
\item Intel offers FPGAs for servers
\begin{itemize}
\item There was some reason why Intel bought Altera (but now back to Altera)
...
\item 02207: Verification of Digital Designs
...
\item We also have a \href{https://chattutor.dk}{ChatTutor} for this course
\end{itemize}
\end{frame}
...
\item The hand-ins, the vending machine, and the report are graded
\end{itemize}
\end{frame}
...
\item Show it on Lab 1%(down to the Basys3)
\end{itemize}
\end{frame}
...
\begin{itemize}
\item What is \href{https://tinytapeout.com/}{Tiny Tapeout}?
\item Tiny Tapeout can have your design on a real chip
\item For EUR 50 instead of \$ 15000
\item We have a TT workshop at DTU: Saturday, February 21
\item Registration fee of 100 DKK includes one tile
\item Sign up soon!
\item Given by Matt Venn, the founder of Tiny Tapeout
\item \url{https://edu4chip.github.io/ttw2026DTU.html}
\item DTU will buy some PCBs
\item Test your chip at a bring-up party
\end{itemize}
\end{frame}
