...
\item The power comes with Scala for generators
...
\begin{itemize}
\item We can specify constants with a different base from 10
...
\item E.g., the width of the multiplication is the sum of the width of \code{a} and width of \code{b} 
\end{itemize}
...
\item Updated on the rising edge of clock
...
\item Statement order has not much meaning
\end{itemize}
\end{frame}
...
\item We need a modern language for hardware/systems design for efficient/fast designing
