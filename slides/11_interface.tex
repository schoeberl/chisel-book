...
\begin{frame}[fragile]{I have seen similar code (not yewt this year)}
\begin{chisel}
  when(io.coin2) {
    sum := sum + 2.U
  } .elsewhen(io.coin5) {
...
\item All other live cells die in the next generation
\item Similarly, all other dead cells stay dead
\end{itemize}
\end{frame}
